...
graph TD
    ...
    subgraph Timeline [The Cosmic Timeline Boundary Regimes]
        direction LR
        
        %% Nodes Definition
        A["a(t) → 0<br>(Singularity Bound)"] 
        B["a(t) → 1<br>(Current Epoch)"] 
        C["a(t) → ∞<br>(Asymptotic Flatness)"]

        A1["<b>Hamiltonian Phase Stasis</b><br>Real Flatness Floor (Re=0.5)"]
        B1["<b>Exact Einsteinian Boundary</b><br>Complex Dynamic Equilibrium"]
        C1["<b>Terminal Dark Energy State</b><br>Cosmological Constant Λ Baseline"]
